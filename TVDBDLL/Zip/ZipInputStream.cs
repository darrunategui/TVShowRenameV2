...
using TVDBDLL.SharpZipLib.Checksums;
using TVDBDLL.SharpZipLib.Zip.Compression;
using TVDBDLL.SharpZipLib.Zip.Compression.Streams;

#if !NETCF_1_0
using TVDBDLL.SharpZipLib.Encryption;
using TVDBDLL.ICSharpCode.SharpZipLib.Zip;
#endif

namespace TVDBDLL.SharpZipLib.Zip
{
	/// <summary>
